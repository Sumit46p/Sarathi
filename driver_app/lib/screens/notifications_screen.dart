...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  Future<void> _playNotificationSound() async {
    try {
      ...
      _log('Failed to play notification sound: $e');
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Notifications', style: GoogleFonts.plusJakartaSans(fontWeight: FontWeight.w600, color: Colors.white)),
  ...
  void _log(String message) => debugPrint('[NotificationsScreen] $message');
}
